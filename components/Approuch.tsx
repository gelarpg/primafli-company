        ...
        <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
            ...
            <div>
              {/* Heading */}
              <div className="mb-4">
                <h3 className="text-gray-500/20 text-xs font-medium uppercase">
                  Steps
                </h3>
              </div>
              {/* End Heading */}
              ...
              <a
                className="group inline-flex items-center gap-x-2 py-2 px-3 bg-gray-500/20 font-medium text-sm text-neutral-800 rounded-full focus:outline-hidden"
                href="#"
              >
                <svg
